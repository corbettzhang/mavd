...
/**
 * <a href="https://github.com/kwhat/jnativehook#software-and-hardware-requirements">JNativeHook</a>
 * 是一个提供Java全局键盘和鼠标侦听器的库。这将使您能够侦听全局快捷方式或鼠标移动，而使用纯Java则无法实现。
 * 为了完成此任务，JNativeHook通过Java的本机接口利用了依赖于平台的本机代码来创建低级系统范围的钩子，并将
 * 这些事件传递给您的应用程序。
 *
